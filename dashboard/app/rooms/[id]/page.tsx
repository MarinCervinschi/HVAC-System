...
export default function RoomDetailPage() {
  ...
  // Dati di prova per sviluppo locale
  // Mock data adattati dal JSON fornito
  const mockRoom: Room = {
    room_id: "room_A1",
  ...
  // Sostituisci fetchRoom con mock se in sviluppo
  useEffect(() => {
      ...
      <Card>
...

        {
          ...
          .map(obj => (
            ...
            key={obj.id}
            smartObject={obj} 
            sensorTypes={obj.sensors.map(sensor => {
              const lastPart = sensor.type.split(":").pop() || "";
