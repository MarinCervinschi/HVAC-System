...
export function PolicyDialog({ smartObject }: PolicyDialogProps) {
    ...
    // Sensori disponibili per la selezione
    ...
    useEffect(() => {
        const loadPolicies = async () => {
            ...
            setIsLoading(true)
            try {
                const response = await fetch(`/api/room/${smartObject.room_id}/rack/${smartObject.rack_id || 'default'}/device/${smartObject.id}/policy`)
                if (response.ok) {
                    ...
                    setPolicies([
                        {
                            ...
                            description: "Temperature control for room 002 - Low temperature threshold",
                            room_id: smartObject.room_id,
    ...
    const handleUpdatePolicy = async () => {
        ...
        try {
            const response = await fetch(`/api/room/${smartObject.room_id}/rack/${smartObject.rack_id}/device/${smartObject.id}/policy/${editingPolicy.id}`, {
                method: 'PUT',
                headers: {
    ...
    const handleDeletePolicy = async (policyId: string) => {
        ...
        try {
            const response = await fetch(`/api/room/${smartObject.room_id}/rack/${smartObject.rack_id}/device/${smartObject.id}/policy/${policyId}`, {
                method: 'DELETE',
            })
    ...
    const handleCreatePolicy = async () => {
        try {
            const response = await fetch(`/api/room/${smartObject.room_id}/rack/${smartObject.rack_id}/device/${smartObject.id}/policy`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                                    ...
                                    <CardHeader className="pb-3">
                                        <div className="flex items-start justify-between">
                                            <div className="flex flex-row gap-2 space-y-1 items-center">
                                                <div
                                                    className="flex h-10 w-10 items-center justify-center rounded-full bg-blue-200 text-blue-800 mr-3"
                                                >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                                            setEditingPolicy((prev) => (prev ? { ...prev, description: e.target.value } : null))
                                        }
                                ...
                                <div className="grid gap-4 md:grid-cols-2">
                                    <div className="space-y-2">
                                        ...
                                        <Select
                                            ...
                                            onValueChange={(value) => {
                                                const selectedSensor = availableSensors.find(s => s.resource_id === value)
                                                setEditingPolicy((prev) => (prev ? { ...prev, resource_id: value } : null))
                                            }}
                                        >
                                        ...
                                        onChange={(e) =>
                                            setEditingPolicy((prev) =>
                                                prev
                                                    ? {
                                                        ...prev,
                                                        condition: { ...prev.condition, value: Number.parseFloat(e.target.value) },
                                                    }
                                                    : null,
                                            )
                                        }
                                    ...
                                    <div className="grid gap-4 md:grid-cols-2">
                                                    ...
                                                    setEditingPolicy((prev) =>
                                                        prev
                                                            ? {
                                                                ...
                                                                action: {
                                                                    command: {
                                                                        value: { ...prev.action.command.value, status: value as any },
                                                                    },
                                                                },
                                                            }
                                                            : null,
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <Input
                                                ...
                                                max="5"
                                                value={
                                                    editingPolicy.action.command.value.speed || editingPolicy.action.command.value.level || ""
                                                }
                                                onChange={(e) => {
